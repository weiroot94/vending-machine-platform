    ...
    <StyledLoginContainer>
      <StyledSignInComponent>
        ...
        <div className="sign-panel">
          ...
          >
            {t("Already")}&nbsp;&nbsp;
            <span style={{ textDecoration: "underline", color: "black" }}>{t("Login")}</span>
          </div>
        </div>
        :
        <div className="resend-mail-form">
            ...
            <p className="resend-mail-input-label">{t("Email")}</p>
            <input
              className="resend-mail-input"
              value={resendEmail}
              readOnly
            />
