...
function VMMachineAdd() {
  ...
  const setType = (typeId, index) => {
    ...
    if (isFind != true) {
      ...
      // Remove original box value from selected box list
      const originalBoxValue = productBoxDropdownlistRefs.current[index].value;
      const updatedBoxList = selectedBoxes.filter(box => box !== originalBoxValue);
      setSelectedBoxes(updatedBoxList);
  ...
  const setTypeStock = (stockValue, typeId, index) => {
    let tempTypeList = selectedTypeList;
    const foundIdx = tempTypeList.findIndex(type => type.type == typeId);
  ...
  const setTypeBox = (boxValue, typeId, index) => {
    if (selectedBoxes.includes(boxValue)) {
      productBoxDropdownlistRefs.current[index].value = "";
      return toast.warn(`${t("Messages.Already_Selected_MSG")}`);
    } else {
      setSelectedBoxes([...selectedBoxes, boxValue]);
    }
  ...
  const checkWizardValidation = (tabIndex) => {
    return true;
  };
  ...
  return (
    <Layout title="Add Vending Machine" content="container">
      <Block.Head>
        <Block.HeadBetween>
          <Block.HeadContent>
            <Block.Title tag="h2">{t("Machine.Add")}</Block.Title>
            <nav>
      ...
      <Block>
        <StepWizard ref={stepWizard}>
          ...
          <div>
            <Row className="g-gs">
              <h3>{t("Machine.Step")} 1: {t("Machine.SerialNumber")}</h3>
              <Col lg="12">
                <div className="form-control-wrap">
                    <Form.Control
                      ...
                      placeholder="Vernding Machine Serial Number"
                    />
                  </div>
              </Col>
            </Row>
          ...
          {/* Advertisement */}
          <div>
            <h3>{t("Machine.Step")} 2: {t("Machine.Advertisement")}</h3>
            <Row className="g-gs">
              <Col lg="12">
                <br></br>
                <div className="form-control-wrap">
          ...
          {/* Information */}
          <div>
            <h3>{t("Machine.Step")} 3: {t("Machine.Information")}</h3>
            <Row className="g-gs">
              <Col lg="12">
                <br></br>
                <div className="form-control-wrap">
          ...
          {/* Products */}
          <div>
            <h3>{t("Machine.Step")} 4: {t("Machine.Products")}</h3>
            <Row className="g-gs">
              <Col lg="12">
                  <div className="form-control-wrap">
                    <ListGroup>
                          ...
                          >
                            ...
                            <div className="d-flex flex-direction-row gap-5">
                              ...
                              >
                                ...
                                >
                                  <option value={""} selected disabled hidden>{t("Options.Select")}</option>
                                  {boxList.map((box) => (
          ...
          {/* Cash */}
          {/* <div>
            <h3>{t("Machine.Step")} 6: {t("Machine.Cash")}</h3>
            <Row className="g-gs">
              <Col lg="12">
                 <div className="form-control-wrap">
                    <ListGroup>
          ...
          {/* Location */}
          <div>
            <h3>{t("Machine.Step")} 5: {t("Machine.Location")}</h3>
            <Row className="g-gs">
            ...
            <Row className="g-gs">
              ...
              <Col lg={{ span:3, offset: 6}}>
                <br></br>
                <Button onClick={handleComplete} style={{ width: "100%" }}>{t("Machine.Add")}</Button>
              </Col>
            </Row>
          </div>
        </StepWizard>
