                            ...
                            <Card className="card-gutter-md">
                                <Card.Body>
                                    <Row className="g-gs">
                                        <Col lg="12">
                                            <Form.Group className="form-group">
                                                ...
                                                <div className="form-control-wrap">
                                                    <Form.Control type="text" id="category-name" defaultValue="Household" placeholder="Category Name"/>
                                                </div>
                                            </Form.Group>
                                        </Col>
                                        <Col lg="12">
                                        ...
                                        <Col lg="6">
                                            <Form.Group className="form-group">
                                                <Form.Label htmlFor="meta-tab-title">Meta Tag Title</Form.Label>
                                                <div className="form-control-wrap">
                                                    <Form.Control type="text" id="meta-tab-title" defaultValue="Simple meta tag" placeholder="Meta Tag Title"/>
                                                </div>
                                            </Form.Group>
                                        </Col>
                                        <Col lg="6">
                            ...
                            <Row className="g-gs">
                                <Col className="col-12">
                                    <Form.Group className="form-group">
                                        ...
                                        <div className="form-control-wrap">
                                            <ImageUpload src="/images/product/a.jpg"/>
                                        </div>
