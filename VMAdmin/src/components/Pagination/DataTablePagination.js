...
const DataTablePagination = ({itemPerPage, totalItems, paginate, currentPage, showItemPerPage, onChangeRowsPerPage, setShowItemPerPage, ...props}) => {
  ...
  return (
    <div className="pagination-wrap">
        ...
        <div className="pagination-info small">
            {t("Table.Showing")} {itemPerPage*(currentPage-1)+1} {t("Table.To")} {(totalItems > itemPerPage*currentPage) ? itemPerPage*currentPage : totalItems} {t("Table.Of")} {totalItems} {t("Table.Entries")}
        </div>
    </div>
  );
};
